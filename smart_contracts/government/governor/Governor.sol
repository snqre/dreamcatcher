...
contract DreamcatcherGovernor is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCompatibilityBravoUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable, GovernorTimelockControlUpgradeable {
    ...
    function initialize(IVotesUpgradeable _token, TimelockControllerUpgradeable _timelock)
        initializer public
    {
        __Governor_init("DreamcatcherGovernor");
        __GovernorSettings_init(7200 /* 7200 block */, 201600 /* 4 week */, 10000e18);
