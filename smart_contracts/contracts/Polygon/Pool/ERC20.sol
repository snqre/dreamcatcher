...
contract ERC20Cap is IERC20 {
    ...
    function maxSupply() public view returns (uint256) {return my.maxSupply;}
    function mintable() public view returns (uint256) {return my.mintable;}
    function balanceOf(
        address _owner
