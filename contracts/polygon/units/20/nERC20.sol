 ...
 */
contract nERC20 is Context, IERC20, IERC20Metadata {
    bytes32 internal constant _ERC20 = keccak256('node.ERC20');
    ...
    function ERC20() internal pure returns (storageERC20 storage s) {
        bytes32 location = _ERC20;
        assembly {
            s.slot := location
        }
    }
